...
async function createUATWorkbook() {
  ...
  wsUsers.columns = [
    ...
    { header: 'Nhóm Vai Trò Cần Test (RBAC)', key: 'roleGroup', width: 28 },
    { header: 'Mã Quyền (CASL)', key: 'roleCode', width: 20 },
    { header: 'Tester 1 Chính (datnc3)', key: 'tester1Lead', width: 25 },
    { header: 'User Test Của Đạt (U1)', key: 'tester1User', width: 22 },
    { header: 'Mật Khẩu (U1)', key: 'tester1Pass', width: 16 },
    { header: 'Tester 2 Chính (diepnx)', key: 'tester2Lead', width: 25 },
    { header: 'User Test Của Điệp (U2)', key: 'tester2User', width: 22 },
    { header: 'Mật Khẩu (U2)', key: 'tester2Pass', width: 16 },
    { header: 'Trọng Tâm & Phạm Vi Kiểm Thử UAT', key: 'scope', width: 45 },
    { header: 'Ghi Chú & Điều Kiện', key: 'note', width: 25 },
  ];

  // Header Title Banner
  wsUsers.mergeCells('A1:K1');
  const title1 = wsUsers.getCell('A1');
  title1.value = 'DANH SÁCH PHÂN CÔNG 2 TESTER CHÍNH (DATNC3 & DIEPNX) & CÁC TÀI KHOẢN THEO VAI TRÒ TEST UAT';
  ...
  wsUsers.mergeCells('A2:K2');
  const sub1 = wsUsers.getCell('A2');
  sub1.value = '2 TESTER CHÍNH ĐIỀU PHỐI & THỰC HIỆN TOÀN BỘ UAT: Nguyễn Cảnh Đạt (datnc3) & Ninh Xuân Điệp (diepnx) | Mật khẩu mặc định toàn bộ tài khoản: @Lpbank2026!';
  sub1.font = { name: 'Arial', size: 10, bold: true, color: { argb: 'FF92400E' } };
  sub1.fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: GOLD_LIGHT } };
  sub1.alignment = { horizontal: 'center', vertical: 'middle' };
  wsUsers.getRow(2).height = 26;

  const headerRow1 = wsUsers.getRow(3);
  headerRow1.height = 32;
  headerRow1.values = [
    'STT', 'Nhóm Vai Trò Cần Test (RBAC)', 'Mã Quyền (CASL)', 
    'Tester 1 Chính (datnc3)', 'User Test Của Đạt (U1)', 'Mật Khẩu (U1)',
    'Tester 2 Chính (diepnx)', 'User Test Của Điệp (U2)', 'Mật Khẩu (U2)',
    'Trọng Tâm & Phạm Vi Kiểm Thử UAT', 'Ghi Chú & Điều Kiện'
  ];
  headerRow1.font = { name: 'Arial', size: 9.5, bold: true, color: { argb: 'FFFFFFFF' } };
  ...
  const uatPersonnel = [
    {
      ...
      tester1Lead: 'Nguyễn Cảnh Đạt (datnc3)',
      tester1User: 'hiepnt (Nguyễn Tuấn Hiệp)',
      tester1Pass: '@Lpbank2026!',
      tester2Lead: 'Ninh Xuân Điệp (diepnx)',
      tester2User: 'thanhpd (Phạm Đức Thành)',
      ...
      note: 'Đăng nhập hiepnt / thanhpd để test',
    },
    {
      stt: 2,
      ...
      tester1Lead: 'Nguyễn Cảnh Đạt (datnc3)',
      tester1User: 'luongnt2 (Nguyễn Thị Lương)',
      tester1Pass: '@Lpbank2026!',
      tester2Lead: 'Ninh Xuân Điệp (diepnx)',
      tester2User: 'anhpv7 (Phùng Vân Anh)',
      tester2Pass: '@Lpbank2026!',
      ...
      note: 'Đăng nhập luongnt2 / anhpv7 để test',
    },
    {
      stt: 3,
      ...
      tester1Lead: 'Nguyễn Cảnh Đạt (datnc3)',
      tester1User: 'danhpc (Phan Cảnh Danh)',
      tester1Pass: '@Lpbank2026!',
      tester2Lead: 'Ninh Xuân Điệp (diepnx)',
      tester2User: 'diepnx (Ninh Xuân Điệp)',
      tester2Pass: '@Lpbank2026!',
      ...
      note: 'Điệp dùng chính user diepnx, Đạt dùng danhpc',
    },
    {
      stt: 4,
      roleGroup: '4. Thành Viên Đoàn KT (Auditor)',
      roleCode: 'Auditor',
      tester1Lead: 'Nguyễn Cảnh Đạt (datnc3)',
      tester1User: 'datnc3 (Nguyễn Cảnh Đạt)',
      tester1Pass: '@Lpbank2026!',
      tester2Lead: 'Ninh Xuân Điệp (diepnx)',
      tester2User: 'maict (Cao Thị Mai)',
      tester2Pass: '@Lpbank2026!',
      ...
      note: 'Đạt dùng chính user datnc3, Điệp dùng maict',
    },
    {
      stt: 5,
      ...
      tester1Lead: 'Nguyễn Cảnh Đạt (datnc3)',
      tester1User: 'hoangnk1 (Ngô Kim Hoàng)',
      tester1Pass: '@Lpbank2026!',
      tester2Lead: 'Ninh Xuân Điệp (diepnx)',
      tester2User: 'dungna (Nguyễn Anh Dũng)',
      tester2Pass: '@Lpbank2026!',
      ...
      note: 'Đăng nhập hoangnk1 / dungna để test',
    },
    {
      stt: 6,
      ...
      roleCode: 'Auditee',
      tester1Lead: 'Nguyễn Cảnh Đạt (datnc3)',
      tester1User: 'hanoibm (Trần Quốc Tuấn)',
      tester1Pass: '@Lpbank2026!',
      tester2Lead: 'Ninh Xuân Điệp (diepnx)',
      tester2User: 'saigonbm (Trịnh Minh Đức)',
      tester2Pass: '@Lpbank2026!',
      ...
      note: 'Đăng nhập hanoibm / saigonbm để test',
    },
    {
      stt: 7,
      ...
      tester1Lead: 'Nguyễn Cảnh Đạt (datnc3)',
      tester1User: 'bks.chair (Trưởng BKS)',
      tester1Pass: '@Lpbank2026!',
      tester2Lead: 'Ninh Xuân Điệp (diepnx)',
      tester2User: 'bks.member (Thành viên BKS)',
      tester2Pass: '@Lpbank2026!',
      ...
      note: 'Đăng nhập bks.chair / bks.member để test',
    },
    {
      stt: 8,
      ...
      roleCode: 'Admin',
      tester1Lead: 'Nguyễn Cảnh Đạt (datnc3)',
      tester1User: 'admin (Quản trị viên HT)',
      tester1Pass: '@Lpbank2026!',
      tester2Lead: 'Ninh Xuân Điệp (diepnx)',
      tester2User: 'auditor.ad (Vũ Quản Trị)',
      tester2Pass: '@Lpbank2026!',
      ...
      note: 'Đăng nhập admin / auditor.ad để test',
    },
  ];
  ...
  guideTitle.value = 'HƯỚNG DẪN THỰC HIỆN KIỂM THỬ UAT DÀNH CHO DATNC3 & DIEPNX';
  ...
  const guideSections = [
    ['1. PHÂN CÔNG 2 TESTER CHÍNH', '- Tester 1 (Chính): Nguyễn Cảnh Đạt (datnc3) - KTV chính, Phòng kiểm toán đơn vị kinh doanh.\n- Tester 2 (Đối chiếu): Ninh Xuân Điệp (diepnx) - KTV cao cấp, Phòng kiểm toán đơn vị kinh doanh.\n=> Hai bạn là đầu mối kiểm thử toàn diện toàn bộ 50+ ca kiểm thử trong hệ thống. Tại mỗi ca kiểm thử, hai bạn sử dụng tài khoản được chỉ định tương ứng với vai trò đó để thực hiện thao tác.'],
    ['2. MÔI TRƯỜNG KIỂM THỬ', 'Môi trường Local (Nội bộ Dev/QA): http://localhost:5173\nMôi trường Production VPS (Cloud Staging): https://chinhta.io.vn\nCơ sở dữ liệu: PostgreSQL 15 (ktnb_db)\nTrình duyệt khuyến nghị: Google Chrome hoặc Microsoft Edge phiên bản mới nhất.'],
    ['3. CƠ CHẾ TEST CHÉO ĐỐI CHIỂU', '- Bạn Đạt (datnc3): Đóng vai trò khởi tạo, tạo dữ liệu, gửi duyệt (Tester 1).\n- Bạn Điệp (diepnx): Đóng vai trò phê duyệt, kiểm tra chéo, thử nghiệm ngoại lệ hoặc kiểm tra phân quyền (Tester 2).\n- Đối với các tính năng Realtime Collab (như cùng soạn thảo Working Paper), hai bạn đăng nhập đồng thời trên 2 máy hoặc 2 trình duyệt để kiểm tra tính năng đồng bộ trực tiếp.'],
    ['4. QUY ƯỚC ĐÁNH GIÁ TRẠNG THÁI', 'PASS (Đạt): Tính năng hoạt động đúng mô tả, dữ liệu lưu chuẩn xác, giao diện mượt mà.\nFAIL (Lỗi): Xuất hiện lỗi 400/403/500, nút bấm không phản hồi, lưu sai dữ liệu, tính toán rủi ro sai.\nBLOCKED (Bị chặn): Không thể test case này do chức năng phụ thuộc ở bước trước đang bị FAIL.\nPENDING: Chưa thực hiện test.'],
    ['5. PHÂN LOẠI MỨC ĐỘ LỖI (SEVERITY)', 'CRITICAL: Sập hệ thống, mất dữ liệu, không đăng nhập được, phân quyền sai nghiêm trọng.\nHIGH: Nghiệp vụ cốt lõi không chạy được (không duyệt được kế hoạch, không tạo được working paper, không xuất được báo cáo).\nMEDIUM: Nghiệp vụ chạy được nhưng có lỗi logic nhỏ, lỗi tính toán thứ yếu hoặc hiển thị sai lệch nhẹ.\nLOW: Lỗi chính tả, câu chữ, màu sắc, canh lề hoặc các đề xuất cải tiến UX.'],
    ['6. QUY TRÌNH PHỐI HỢP & BÁO LỖI', 'Bước 1: Hai bạn đăng nhập tài khoản tương ứng với vai trò của Test Case (tham khảo Sheet 01).\nBước 2: Mở Sheet 03, chọn đúng Test Case cần thực hiện.\nBước 3: Thực hiện đúng các bước (Actions) và dữ liệu mẫu (Input Data).\nBước 4: Đối chiếu kết quả màn hình với Kết quả mong đợi (Expected Results).\nBước 5: Điền trạng thái vào cột Kết quả của bạn Đạt (U1) và bạn Điệp (U2), ghi chú lỗi phát sinh nếu có.\nBước 6: Gửi lại file tổng hợp cho Ban dự án để xử lý triệt để các phát sinh.'],
  ];
  ...
  wsTC.columns = [
    ...
    { header: 'Vai Trò Cần Test', key: 'role', width: 20 },
    { header: 'Tài Khoản Đăng Nhập Test', key: 'accountToUse', width: 25 },
    { header: 'Tester 1 (datnc3 - Đạt)', key: 'tester1', width: 16 },
    { header: 'Kết Quả U1', key: 'result1', width: 14 },
    { header: 'Tester 2 (diepnx - Điệp)', key: 'tester2', width: 16 },
  ...
  // Title Banner
  wsTC.mergeCells('A1:R1');
  const tcTitle = wsTC.getCell('A1');
  tcTitle.value = 'BẢNG KỊCH BẢN CHI TIẾT KIỂM THỬ UAT - 2 TESTER CHÍNH: NGUYỄN CẢNH ĐẠT & NINH XUÂN ĐIỆP';
  ...
  wsTC.mergeCells('A2:R2');
  const tcSub = wsTC.getCell('A2');
  tcSub.value = 'Bạn Đạt (datnc3) và Bạn Điệp (diepnx) đăng nhập bằng tài khoản được chỉ định ở cột "Tài Khoản Đăng Nhập Test" để kiểm thử và ghi nhận kết quả';
  ...
  headerRow3.values = [
    ...
    'Dữ Liệu Đầu Vào Mẫu (Test Input)', 'Kết Quả Mong Đợi (Expected Result)', 'Vai Trò Cần Test',
    'Tài Khoản Đăng Nhập Test', 'Tester 1 (datnc3 - Đạt)', 'Kết Quả U1', 'Tester 2 (diepnx - Điệp)', 'Kết Quả U2', 'Ngày Test', 'Ghi Chú / Bug ID'
  ];
  ...
  const rawTestCases = [
    ...
    // --- MODULE 1: BÀN LÀM VIỆC & ĐIỀU HÀNH ---
    {
      ...
      precondition: 'Đăng nhập tài khoản Lãnh đạo Khối (hiepnt) hoặc Trưởng phòng (luongnt2)',
      steps: '1. Đăng nhập user Lãnh đạo Khối\n2. Truy cập trang chủ /\n3. Xem các chỉ số thẻ KPI\n4. Bấm vào từng card để drill-down',
      inputData: 'User: hiepnt / luongnt2\nPass: @Lpbank2026!',
    ...
    },
    {
      ...
      inputData: 'Trưởng đoàn: diepnx\nKTV 1: datnc3 (Nghiệp vụ Tín dụng)\nKTV 2: maict (Kế toán & Kho quỹ)',
    ...
    },
    {
      ...
      steps: '1. Trưởng đoàn diepnx tạo yêu cầu: "Gia hạn thêm 3 ngày do dữ liệu phức tạp"\n2. Lãnh đạo Phòng luongnt2 nhận thông báo, kiểm tra lý do và bấm "Phê duyệt"',
    ...
    // --- MODULE 4: GIẤY TỜ LÀM VIỆC (WORKING PAPERS) ---
    {
      ...
      precondition: 'Đăng nhập user datnc3 (KTV thành viên)',
      steps: '1. Đăng nhập user datnc3\n2. Mở /working-papers\n3. Bấm "Thêm Giấy tờ làm việc mới"\n4. Chọn Cuộc KT, Nhập Mã WP (WP-TD-01), Tên thủ tục\n5. Bấm "Tạo"',
    ...
    },
    {
      ...
      precondition: 'Đang mở Working Paper WP-TD-01',
    ...
    },
    {
      ...
      precondition: 'Bạn Đạt (datnc3) và Bạn Điệp (diepnx) cùng mở 1 WP trên 2 trình duyệt',
      steps: '1. Bạn Đạt mở WP-TD-01 và gõ văn bản\n2. Bạn Điệp cùng mở WP-TD-01 trên trình duyệt khác\n3. Quan sát con trỏ chuột và chữ xuất hiện tức thì',
      inputData: 'Gõ chữ đồng thời tại 2 vị trí khác nhau trong văn bản',
      expectedResult: 'Nhìn thấy con trỏ màu đại diện cho bạn Điệp, văn bản đồng bộ realtime không bị ghi đè dữ liệu.',
      role: '2 KTV phối hợp',
      accountToUse: 'datnc3 & diepnx',
    },
    {
    ...
    },
    {
      ...
      steps: '1. KTV datnc3 bấm nút "Gửi Trưởng đoàn soát xét"\n2. Nhập ghi chú bàn giao\n3. Bấm xác nhận',
      inputData: 'Ghi chú: "Em Đạt đã hoàn thành kiểm tra 10 hồ sơ mẫu, kính gửi anh Điệp soát xét."',
    ...
    },
    {
      ...
      precondition: 'Đăng nhập tài khoản Trưởng đoàn (diepnx)',
      steps: '1. Trưởng đoàn diepnx mở WP-TD-01 ở trạng thái Submitted\n2. Bôi đen đoạn văn bản nghi vấn và bấm "Tạo Review Note"\n3. Nhập câu hỏi yêu cầu giải trình\n4. Bấm "Gửi Note"',
      inputData: 'Nội dung Note: "Thiếu chứng thư thẩm định giá số 12/2025, đề nghị KTV Đạt bổ sung."',
      expectedResult: 'Review Note màu vàng ghim vào đúng vị trí văn bản. KTV datnc3 nhận thông báo cần xử lý.',
      role: 'Trưởng đoàn kiểm toán',
      accountToUse: 'diepnx',
    },
    {
      ...
      steps: '1. Bạn Đạt mở Note, nhập phản hồi giải trình và đính kèm bổ sung tài liệu\n2. Bạn Điệp kiểm tra và bấm "Đóng Note (Close Note)"',
    ...
    },
    {
      ...
      precondition: 'Trưởng đoàn diepnx đã soát xét xong danh mục phát hiện',
    ...
    },
    {
      ...
      accountToUse: 'diepnx -> luongnt2 -> hiepnt',
    },
    {
      tcId: 'TC-REP-04',
      module: '7. Báo Cáo Kiểm Toán',
    ...
    },
    {
      ...
      inputData: 'Filter: User = datnc3 hoặc Action = CREATE',
  ...
  rawTestCases.forEach((tc, idx) => {
    const row = wsTC.addRow({
      ...
      role: tc.role,
      accountToUse: tc.accountToUse,
      tester1: 'Nguyễn Cảnh Đạt (datnc3)',
      result1: 'Chưa test',
      tester2: 'Ninh Xuân Điệp (diepnx)',
      result2: 'Chưa test',
      testDate: '',
      defectNotes: '',
    });
    ...
    row.getCell('accountToUse').alignment = { horizontal: 'center', vertical: 'middle' };
    row.getCell('tester1').alignment = { horizontal: 'center', vertical: 'middle' };
    row.getCell('tester2').alignment = { horizontal: 'center', vertical: 'middle' };
    ...
    row.getCell('accountToUse').font = { name: 'Arial', size: 9, bold: true, color: { argb: 'FF92400E' } };
    row.getCell('tester1').font = { name: 'Arial', size: 9, bold: true, color: { argb: 'FF1E3A8A' } };
    row.getCell('tester2').font = { name: 'Arial', size: 9, bold: true, color: { argb: 'FF047857' } };
  });
  ...
  console.log(`Successfully generated updated UAT Workbook at: ${outPath}`);
}
